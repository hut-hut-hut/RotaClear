      ...
      <div className="flex-1 px-6 py-6">
        <div className="max-w-6xl mx-auto">
          <div className={activeTab === 'leave' ? '' : 'hidden'}>
            <LeaveTab selectedDoctor={selectedDoctor} rotaData={rotaData} isActive={activeTab === 'leave'} onGoToRules={() => onTabChange('rules')} onChangeUser={onChangeUser} onRemoveRota={() => setShowConfirm(true)} />
          </div>
          <div className={activeTab === 'swaps' ? '' : 'hidden'}>
            <SwapsTab selectedDoctor={selectedDoctor} rotaData={rotaData} isActive={activeTab === 'swaps'} onChangeUser={onChangeUser} onRemoveRota={() => setShowConfirm(true)} />
          </div>
